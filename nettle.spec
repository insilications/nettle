...
Group: Default
Requires: nettle-dev32 = %{version}-%{release}
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610610735
...
make  %{?_smp_mflags}  V=1 VERBOSE=1 LDFLAGS="${LDFLAGS} -Wl,--whole-archive /usr/lib64/libcrypto.a /usr/lib64/libssl.a -Wl,--no-whole-archive" CFLAGS="${CFLAGS} /usr/lib64/libcrypto.a /usr/lib64/libssl.a -Wl,--no-whole-archive"
